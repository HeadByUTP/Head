<?php
	class Videosy extends Controllers{
		...
		public function Videosy()
		{
			...
			$data['page_functions_js'] = "functions_videosy.js";
			$this->views->getView($this,"videosy",$data);
		}

        		//Muestra todos los registros de la entidad en DataTable
		public function getVideosy()
		{
			if($_SESSION['permisosMod']['r'])
			{
				$arrData = $this->model->selectVideosy();
		...
		public function delVideo()
		{
			if($_POST)
			{
				if($_SESSION['permisosMod']['d'])
				{
					...
					$requestDelete = $this->model->deleteVideo($intIdCuatrimestre);
					if($requestDelete == 'ok'){
