            ...
            <div class="vizew-archive-list-posts-area mt-120 mb-120">
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <p><b>Ver todos los </b><a href="<?= base_url() ?>/canal"> videos</a> </p>
                        <?php
                        ...
                        ?>
                            ...
                            <nav class="mt-50">
                                <ul class="pagination justify-content-center">
                                    ...
                                    if($data['pagina'] > 1){
                                    ?>
                                        <li class="page-item"><a class="page-link" href="<?= base_url() ?>/Canal/search?p=<?= $prevPagina ?>&s=<?= $data['busqueda'] ?>"><i class="fa fa-angle-left"></i> Anterior </a></li>
                                    <?php } ?>
                                    <?php if($data['pagina'] != $data['total_paginas']){ ?>
                                        <li class="page-item"><a class="page-link" href="<?= base_url() ?>/Canal/search?p=<?= $nextPagina ?>&s=<?= $data['busqueda'] ?>">Siguiente <i class="fa fa-angle-right"></i></a></li>
                                    <?php } ?>
                                    <?php } ?>
                                </ul>
                            </nav>
