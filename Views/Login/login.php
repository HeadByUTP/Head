...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Universidad Tecnologica de Puebla">
  ...
  <body>
    ...
    <section class="login-content"> 
      ...
      <img width="100" class="p-1 mb-2" src="https://lh3.googleusercontent.com/proxy/jIPolNuVCemobYQQbCGB98HdJ92jH4EM0q8-qb-VQf4IiRJbPLEiX9jHJxvYhlwmpXANWbqXb2jY7Z6LvfR3gTj0w92Tsw" alt="">
      <img width="100" class="p-1 mb-2" src="https://lh3.googleusercontent.com/proxy/jIPolNuVCemobYQQbCGB98HdJ92jH4EM0q8-qb-VQf4IiRJbPLEiX9jHJxvYhlwmpXANWbqXb2jY7Z6LvfR3gTj0w92Tsw" alt="">
      <img width="100" class="p-1 mb-2" src="https://lh3.googleusercontent.com/proxy/jIPolNuVCemobYQQbCGB98HdJ92jH4EM0q8-qb-VQf4IiRJbPLEiX9jHJxvYhlwmpXANWbqXb2jY7Z6LvfR3gTj0w92Tsw" alt="">  
      </div>
      <div class="logo">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmail" name="txtEmail" class="form-control" type="email" required placeholder="Email" title="Asegurese de que su dirección de correo esté bien escrita y el dominio coincida con 'utpuebla.edu.mx'" autofocus>
          </div>
          <div class="form-group">
