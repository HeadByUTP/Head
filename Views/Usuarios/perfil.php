    ...
    <div class="col-md-3">
      <div class="tile p-0">
        <ul class="nav flex-column nav-tabs user-tabs">
          ...
          <li class="nav-item"><a class="nav-link" href="#user-settings" data-toggle="tab">Datos académicos</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-9">
      <div class="tab-content">
        <div class="tab-pane active" id="user-timeline">
          <div class="timeline-post">
            <div class="post-media">
              <div class="content">
                <h4>Datos personales <button class="btn btn-sm btn-info" type="button" onclick="openModalPerfil();"><i class="fas fa-pencil-alt" aria-hidden="true"></i></button></h4>
                <hr>
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="user-settings">
          <div class="tile user-settings">
            ...
            <hr>
            <form id="formDataAcademic" name="formDataAcademic">
            <input type="hidden" name="User" id="User">
            <p>Universidades y divisiones/carreras en que realiza actividades docentes:</p>
            <div class="row">
              <div class="col-lg-12 w-100">
                <div class="row" id="datosA">
                </div>
              </div>
            </div>
              <div class="row mb-10">
